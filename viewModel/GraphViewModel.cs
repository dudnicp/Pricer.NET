...
namespace PricingApp.viewModel
{
    public class GraphViewModel : INotifyPropertyChanged
    {
        ...
        private List<TrackedResults> resultsEvolution;
        public List<TrackedResults> ResultsEvolution
        {
            get
            {
                return resultsEvolution;
            }
            set
            {
                if(resultsEvolution != value)
                {
                    resultsEvolution = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("ResultsEvolution"));
                }
            }
        }
        ...
        public SeriesCollection SeriesCollection2
        {
            ...
            set
            {
                if (value != seriesCollection2)
                {
                    seriesCollection2 = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("SeriesCollection2"));
                }
            }
        }
